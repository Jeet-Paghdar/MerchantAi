...
Rules:
1. Whenever the customer asks for or mentions products (e.g. phones, shoes, sneakers, earbuds, laptops), ALWAYS use the `search_products` tool immediately to fetch live catalog items so they display visually in the UI.
